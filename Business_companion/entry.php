...
<input type="radio" name="type" value="4">ALL Entries<br>
...
require 'connect.inc.php';
  ...
  {   $query="SELECT * FROM journal";
      ...
      {$n=mysql_num_rows($query_run);
       if($n==0)
        echo 'There is not any entry in Database.';
       else{
         echo '
        <table border="1">
        <tr>
...
<input type ="submit" value="View"><br>
         ...
         <?php
           ...
           {$c=$_POST[id];
            echo "<br><p />Image stored in ID: $c<p /><img src=view.php?id=$c style=\"max-height: 250px; max-width: 250px;\">";
     ...
     {$query="SELECT * FROM journal WHERE id=$b";
      ...
      {$n=mysql_num_rows($query_run);
       if($n==0)
        ...
        echo "<p />Image attached:<p /><img src=view.php?id=$b style=\"max-height: 250px; max-width: 250px;\">";
       }
       }
...
<input type ="submit" value="View"><br><br>
         ...
         <?php
           if(isset($_POST['id'])&&!empty($_POST['id']))
           {$c=$_POST[id];
            echo "<br><br><p />Image stored in ID: $c<p /><img src=view.php?id=$c style=\"max-height: 250px; max-width: 250px;\">";
